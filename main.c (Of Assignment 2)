...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
char* task1_data = "Task 1 is Running!\r\n";
char* task2_data = "Task 2 is Running!\r\n";
char* task3_data = "Task 3 is Running!\r\n";
...
void StartTask1(void const * argument)
{
  ...
  for(;;)
  {
	  HAL_UART_Transmit(&huart2, (uint8_t*) task1_data, strlen(task1_data), HAL_MAX_DELAY);
...
void StartTask02(void const * argument)
{
  ...
  for(;;)
  {
	  HAL_UART_Transmit(&huart2, (uint8_t*) task2_data, strlen(task2_data), HAL_MAX_DELAY);
...
void StartTask03(void const * argument)
{
  ...
  for(;;)
  {
	  HAL_UART_Transmit(&huart2, (uint8_t*) task3_data, strlen(task3_data), HAL_MAX_DELAY);
